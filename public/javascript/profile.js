    ...
    success: function (data) {
      for (let i = 0; i < data.length; i++) {
        $('.routine-results').append(`<div data-routine-id="${data[i]._id}" class="routine-click">
                                        ...
                                        <li><a href="${data[i].targetMuscle}">${data[i].targetMuscle}</a></li>
                                        <p class="routine-category">Workout</p>
                                        <li><a href="${data[i].workout}">${data[i].workout}</a></li>
    ...
    $.ajax({
      ...
      success: (response) => {
        if (response) {
          ...
          $('.sets').val('');
          $('.author').val('');
          $('.routine-results').html(`<div data-routine-id="${response._id}" class="routine-click">
                                        <p class="routine-category">Muscle Group</p>
                                        <li><a href="${response.targetMuscle}">${response.targetMuscle}</a></li>
                                        <p class="routine-category">Workout</p>
                                        <li><a href="${response.workout}">${response.workout}</a></li>
                                        <p class="routine-category">Repetitions</p>
